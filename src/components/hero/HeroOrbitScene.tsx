  ...
  return (
    <section className="relative border-b border-line">
      ...
      <div className="relative h-[86vh] min-h-[560px] w-full overflow-hidden">
        ...
        >
          <SpaceBackground paused={reducedMotion} />
          <AbstractFigure paused={reducedMotion} />
          <OrbitRing
            items={items}
        ...
        <div className="pointer-events-none absolute inset-x-0 top-[6%] z-10 flex flex-col items-center gap-3 px-4">
          ...
          <div className="text-center">
            <p className="font-mono text-sm uppercase tracking-wide text-signal">{t.hero.role}</p>
      ...
      <div className="flex flex-col items-center gap-4 border-t border-line py-8">
            ...
            <button
              ...
              className={cn(
                ...
                w === world
                  ...
                  : "border-line-strong text-text-muted hover:border-text-muted hover:text-text"
              )}
            >
              {t.orbit.worlds[w]}
            </button>
        ...
        <p className="max-w-sm text-center text-xs text-text-dim">{t.orbit.worldTagline[world]}</p>
      </div>
...
function NavButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      aria-label={label}
      className="flex h-14 w-14 items-center justify-center rounded-full border border-line-strong bg-bg/60 text-text backdrop-blur-sm transition-colors hover:border-signal hover:text-signal sm:h-16 sm:w-16"
    >
