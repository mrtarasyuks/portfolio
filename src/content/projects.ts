...
export const projects: PortfolioProject[] = [
  {
    ...
    media: [
      { kind: "diagram", label: "Input → AI proxy → model routing → Supabase → product UI" },
      { kind: "screenshot", label: "Foody screen 1", src: "/img/foody_screens/screen01.png" },
      { kind: "screenshot", label: "Foody screen 2", src: "/img/foody_screens/screen02.png" },
      { kind: "screenshot", label: "Foody screen 3", src: "/img/foody_screens/screen03.png" },
      { kind: "screenshot", label: "Foody screen 4", src: "/img/foody_screens/screen04.png" },
      { kind: "screenshot", label: "Foody screen 5", src: "/img/foody_screens/screen05.png" },
      { kind: "screenshot", label: "Foody screen 6", src: "/img/foody_screens/screen06.png" },
      { kind: "screenshot", label: "Foody screen 7", src: "/img/foody_screens/screen07.png" },
      { kind: "screenshot", label: "Foody screen 8", src: "/img/foody_screens/screen08.jpg" },
    ],
    verificationNote: {
  ...
  },
  {
    ...
    media: [
      { kind: "screenshot", label: "appfoody.com screen 1", src: "/img/appfoody_screens/screen01.jpg" },
      { kind: "screenshot", label: "appfoody.com screen 2", src: "/img/appfoody_screens/screen02.jpg" },
      { kind: "screenshot", label: "appfoody.com screen 3", src: "/img/appfoody_screens/screen03.jpg" },
      { kind: "screenshot", label: "appfoody.com screen 4", src: "/img/appfoody_screens/screen04.jpg" },
    ],
  },
  {
    slug: "frameforg",
    ...
    media: [
      { kind: "diagram", label: "Brief → storyboard → generation → Remotion → audio → QA → delivery" },
      { kind: "screenshot", label: "FrameForg screen 1", src: "/img/frameforg_screens/screen01.jpg" },
      { kind: "screenshot", label: "FrameForg screen 2", src: "/img/frameforg_screens/screen02.jpg" },
      { kind: "screenshot", label: "FrameForg screen 3", src: "/img/frameforg_screens/screen03.jpg" },
      { kind: "screenshot", label: "FrameForg screen 4", src: "/img/frameforg_screens/screen04.jpg" },
      { kind: "screenshot", label: "FrameForg screen 5", src: "/img/frameforg_screens/screen05.jpg" },
      { kind: "screenshot", label: "FrameForg screen 6", src: "/img/frameforg_screens/screen06.jpg" },
      { kind: "screenshot", label: "FrameForg screen 7", src: "/img/frameforg_screens/screen07.jpg" },
      { kind: "screenshot", label: "FrameForg screen 8", src: "/img/frameforg_screens/screen08.jpg" },
    ],
    verificationNote: {
